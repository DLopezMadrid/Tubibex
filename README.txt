...
Capture tube paper: L. Jaulin, D. Lopez, Le Doze, S. Le Menec, J. Ninin, G. Chabert, M. S. Ibnseddik, A. Stancu (2015), Computing capture tubes, Reliable Computing, accepted.

pdf:
https://www.ensta-bretagne.fr/jaulin/paper_captube.pdf

also found in doc folder
...
Tubibex was developed in Linux Mint 17.2 x64 and it uses the following software packages:
	...
	-gdb 7.9.1
		...
		install commands (need to be python-enabled)
